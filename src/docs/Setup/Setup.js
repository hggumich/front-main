      ...
      <Container>
        <Stack spacing={{ xs: 4, sm: 8 }}>
          <Box>
            ...
            <Typography>
              Setting up a new MUI React project to use SmartXChain sections,
          ...
          <Box>
            ...
            <Typography mb={2}>
              ...
              SmartXChain theme has, in order to be able to properly use the
              theme and all the UI components.
            </Typography>
            <Typography
              sx={{
                '& code': {
          ...
          <Box>
            ...
            <Typography
              ...
              mb={2}
            >
              In the <b>/src/components</b> folder of the SmartXChain theme
              there are two important files/components which should be copied
              into your working directory. One is{' '}
            ...
            <Box component={'ul'}>
              ...
              <li>
                ...
                >
                  ...
                  free to copy its content from SmartXChain{' '}
              ...
              <li>
                <Typography>
                  ...
                  , you can follow the same approach as done in SmartXChain
                  theme.
                </Typography>
              </li>
            </Box>
    ...
    pages/`)}
          ...
          <Box>
            ...
            <Typography mb={2}>
              ...
              landings and any other components from SmartXChain into your app.
            </Typography>
            <Stack spacing={2}>
              <Box>
              ...
              <li>
                ...
                >
                  <a href="/docs/quick-start-react-scripts">
                    Getting started with SmartXChain (react-scripts)
                  </a>
                  ;
                </Typography>
              </li>
              <li>
                ...
                >
                  <a href="/docs/quick-start-nextjs">
                    Getting started with SmartXChain (nextjs)
                  </a>
                  ;
                </Typography>
              </li>
              <li>
                ...
                >
                  <a href="/docs/quick-start-gatsbyjs">
                    Getting started with SmartXChain (gatsbyjs)
                  </a>
                  ;
                </Typography>
              </li>
