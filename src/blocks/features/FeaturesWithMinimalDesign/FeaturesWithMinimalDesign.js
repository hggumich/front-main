...
const mock = [
  {
    ...
    subtitle:
      'We bring over 2,500 journalists from the world’s leading publications to SmartXChain. They’re part of the reason why the event has a global reach of over three billion. We can also work with you on bespoke content packages that will tell your story on a global scale.',
    icon: (
      <svg
        width={40}
        height={40}
  ...
  },
  {
    ...
    subtitle:
      '70,000 people will be joining us at Web Summit this November. They are deeply embedded in the fabric of their respective industries – the trendsetters dictating how quickly new technologies are adopted.',
    icon: (
      <svg
        width={40}
        height={40}
